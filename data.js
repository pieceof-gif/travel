...
var v1_0_9_DEST_DATA = [
        {
          ...
          hotelTips: ['Booking.com 지니어스 회원 가입 시 10% 추가 할인','화요일·수요일 예약 시 평균 8% 저렴','구시가(알파마·시아두) 지역 숙소가 관광 동선 최적','리스본 카드 포함 패키지 숙소 비교 권장'
          ],
          cheapFlights: [
            { label:'핀에어 (헬싱키 경유)', desc:'약 16시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/lis/' },
            { label:'터키항공 (이스탄불 경유)', desc:'약 16시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/lis/' }
          ],
          flightTips: ['직항 없음 · 헬싱키·이스탄불·도하 경유가 가장 저렴','출발 2-3개월 전 화요일 오전 예약 시 평균 15% 절약','네이버 항공 가격 알림 기능 활용 권장','스카이스캐너 전체 월 검색으로 최저가 날짜 확인'
          ]
        },
        {
          ...
          hotelTips: ['Agoda·Booking.com 가격 비교 필수 (최대 30% 차이)','미케비치(My Khe) vs 안방비치(An Bang) 지역 선택 중요','한국어 가능 직원 여부 예약 전 확인 권장','체크인 시 동(VND) 현금 지불 시 할인 가능한 숙소 多'
          ],
          cheapFlights: [
            { label:'비엣젯항공 (직항)', desc:'4.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/dad/' },
            { label:'제주항공 (직항)', desc:'4.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/dad/' }
          ],
          flightTips: ['다낭 직항 다수 · 1-2개월 전 예약이 최적 타이밍','비엣젯·제주·티웨이 비교 필수 · 최대 30% 차이 발생','새벽 출발편이 오후 편 대비 평균 10-15% 저렴','다낭은 비수기(5-10월) 항공권 특가 자주 등장'
          ]
        },
        {
          ...
          baseAir: 8, baseHotel: 10, baseHotelLow: 5.5, baseHotelHigh: 28, minDays: 1, minBudget: 20,
          sights: {
            low: [
          ...
          hotelTips: ['여기어때·야놀자 앱 전용 특가 할인 자주 발생','제주 서쪽(애월·한림) vs 동쪽(성산·우도) 동선 먼저 확정','성수기(7-8월, 추석·설) 최소 2개월 전 예약 필수','렌터카 포함 패키지가 개별 예약보다 평균 15% 저렴'
          ],
          cheapFlights: [
            { label:'제주항공 (김포↔제주)', desc:'1시간', link:'https://www.skyscanner.co.kr/transport/flights/gmp/cju/' },
            { label:'티웨이항공 (인천↔제주)', desc:'1시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cju/' }
          ],
          flightTips: ['제주 항공편은 75일 전 예약이 통계적으로 최저가','네이버 항공 특가 알림 설정 후 가격 하락 시 구매','김포-제주가 인천 출발보다 평균 1-2만원 저렴','비수기(11월, 1-2월) 편도 5만원 이하 자주 등장'
          ]
        },
        {
          ...
          baseAir: 20, baseHotel: 8, baseHotelLow: 5, baseHotelHigh: 18, minDays: 2, minBudget: 35,
          sights: {
            low: [
          ...
          hotelTips: ['MRT 노선 도보 5분 이내 숙소 선택이 이동 효율 최고','다핑린(大坪林)·공관(公館) 지역은 시내 대비 20-30% 저렴','한국어 리뷰 많은 Booking.com 필터링 적극 활용','타이베이 패스(교통+관광 통합권) 호텔 로비에서 구매 가능'
          ],
          cheapFlights: [
            { label:'티웨이 (직항)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/tpe/' },
            { label:'이스타항공 (직항)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/tpe/' }
          ],
          flightTips: ['타이베이 직항 경쟁 치열 · 얼리버드 30-45일 전 최저가','타오위안(TPE) 입항 후 MRT 공항철도로 시내 40분 이동','구정 전후 성수기에는 60일 이상 전 예약 강력 권장','카카오페이·토스 결제 시 LCC 앱 추가 할인 적용 가능'
          ]
        },
        {
          ...
          hotelTips: ['난바(難波)·신사이바시 지역이 관광·맛집 동선 최적','엔저 지속 중 · 현금 결제 시 일부 숙소 5% 추가 할인','여행 2-3개월 전 얼리버드 요금으로 최대 40% 절약 가능','도미인 체인은 온천 포함 가성비 최고 · 한국인 선호 높음'
          ],
          cheapFlights: [
            { label:'제주항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/kix/' },
            { label:'피치항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/kix/' }
          ],
          flightTips: ['엔저로 숙박·현지 비용 절약 · 항공도 LCC 경쟁 치열','피치항공 앱 직접 예약 시 최저가 나오는 경우 많음','오사카+교토+나라 권역 묶음 여행 시 JR패스 고려','출발 45-60일 전 화요일 오전 검색 시 최저가 빈도 높음'
          ]
        },
        {
          ...
          hotelTips: ['신주쿠·아사쿠사·도쿄역 주변이 교통·관광 최적 위치','엔저 지속 중 · 현지 결제는 무조건 엔화(현금) 선택','도미인 체인 온천 포함 가성비 최고 · 한국인 선호 압도적','여행 60-90일 전 얼리버드 예약 시 최대 40% 절약'
          ],
          cheapFlights: [
            { label:'제주항공 (직항)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/nrt/' },
            { label:'대한항공 (직항)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/hnd/' }
          ],
          flightTips: ['LCC 기준 왕복 15-25만원 특가 자주 발생 · 알림 설정 필수','하네다는 도심 접근성 최고 · 나리타는 보통 더 저렴','엔저로 항공 외 모든 비용 절감 · 지금이 최적 여행 시기','스카이스캐너 알림 → 화요일 오전 최저가 자주 포착'
          ]
        },
        {
          ...
          hotelTips: ['수쿰빗·실롬·리버사이드 지역이 교통·관광 동선 최적','BTS 스카이트레인 역 도보 5분 이내 숙소 선택 권장','방콕 호텔은 수영장 포함 여부가 만족도 핵심 요소','4성급 호텔도 한국 대비 50% 수준 · 고급 숙소 강력 추천'
          ],
          cheapFlights: [
            { label:'대한항공 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/bkk/' },
            { label:'티웨이 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/bkk/' }
          ],
          flightTips: ['직항 5시간 · LCC 경쟁 치열로 특가 자주 발생','왕복 30-45만원대 특가 → 스카이스캐너 알림 필수','수완나품·돈므앙 두 공항 취항 · 위치 반드시 확인','출발 6-8주 전 화요일 검색 시 최저가 빈도 높음'
          ]
        },
        {
          ...
          hotelTips: ['우붓(자연·힐링)과 스미냑/캉구(해변·나이트라이프)는 완전히 다른 분위기','연인 여행 시 프라이빗 풀빌라 · 한국 대비 50% 수준','발리 리조트는 인피니티풀 여부가 만족도 핵심 요소','우붓 숙소는 계곡 전망·논밭 전망 차이 예약 전 확인 필수'
          ],
          cheapFlights: [
            { label:'에어아시아 (경유)', desc:'7시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/dps/' },
            { label:'가루다 (경유)', desc:'약 10시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/dps/' }
          ],
          flightTips: ['직항 없음 · 싱가포르·KL·자카르타 경유 8-11시간','에어아시아 경유편 왕복 40-55만원대 자주 발생','싱가포르 스탑오버 시 창이공항 무료 투어 활용 가능','발리 고시즌(7-8월, 12월)은 최소 3개월 전 예약 필수'
          ]
        },
        {
          ...
          hotelTips: ['구시가(올드시티) 내부 숙소가 사원 투어 동선 최적','님만헤민 지역은 카페·레스토랑 밀집 · 젊은 층 선호','4-5성 리조트도 방콕 대비 30-40% 저렴 · 고급 숙소 강력 추천','코끼리 투어 예정이면 메이림 지역 숙소 고려'
          ],
          cheapFlights: [
            { label:'대한항공 (방콕 경유)', desc:'약 9시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cnx/' },
            { label:'에어아시아 (KL 경유)', desc:'약 10시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cnx/' }
          ],
          flightTips: ['직항 없음 · 방콕 또는 KL 경유 7-9시간','에어아시아 방콕-치앙마이 국내선 매우 저렴','방콕+치앙마이 묶음 일정 · 방콕 인·치앙마이 아웃 추천','치앙마이 단독 여행 시 방콕 레이오버 2일 추가 강추'
          ]
        },
        {
          ...
          hotelTips: ['오차드·시티홀·마리나베이 지역이 관광·쇼핑 최적','호커 센터 적극 활용 시 식비 70% 절약 가능','MRT 에즈링크 카드 구입 → 교통비 현금 대비 50% 절약','싱가포르는 호텔이 비쌈 · 고급 숙소도 1박 전략 추천'
          ],
          cheapFlights: [
            { label:'스쿠트 (직항)', desc:'6시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/sin/' },
            { label:'싱가포르항공 (직항)', desc:'6시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/sin/' }
          ],
          flightTips: ['직항 6시간 · 스쿠트 직항 왕복 45-60만원대 자주','창이공항 주얼 환승 거점으로 경유도 추천 옵션','60-90일 전 예약 시 LCC 최저가 확보 가능','싱가포르 스탑오버 → 발리·방콕·세부 연계 이상적'
          ]
        },
        {
          ...
          hotelTips: ['세부시티(관광·맛집)와 막탄섬(해변·리조트)은 전혀 다른 경험','한국인 대부분 막탄섬 리조트 선택 · 해변+수영장이 핵심','크림슨 리조트: 가성비+프라이빗 비치 한국인 1위','고래상어(오슬롭) 투어는 새벽 출발 필수 · 전날 남부 숙박 추천'
          ],
          cheapFlights: [
            { label:'제주항공 (직항)', desc:'4시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/ceb/' },
            { label:'대한항공 (직항)', desc:'4시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/ceb/' }
          ],
          flightTips: ['직항 4시간 · LCC 왕복 40-55만원대 특가 정기 발생','태풍 시즌(6-11월) 여행 취소 보험 필수','세부→보라카이 국내선 연계 가능 (경유 여행 추천)','막탄 공항은 세부시티에서 차로 30분 · 공항픽업 사전 예약 권장'
          ]
        },
        {
          ...
          hotelTips: ['나트랑 해변 주변(쩐푸 거리) 숙소가 관광·맛집 동선 최적','다낭 대비 조용하고 깨끗한 해변 · 물이 투명','빈펄 리조트(섬 내)는 케이블카로만 이동 · 별도 예산 필요','해변 직접 연결 리조트 vs 해변 도보 숙소 가격 차이 확인'
          ],
          cheapFlights: [
            { label:'베트남항공 (직항)', desc:'4.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cxr/' },
            { label:'제주항공 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cxr/' }
          ],
          flightTips: ['직항 4.5시간 · 다낭보다 저렴한 경우 많음','왕복 35-45만원대 특가 발생 빈도 높음','나트랑+달랏 묶음 여행 추천 · 버스 3시간 거리','우기(9-12월) 태풍 리스크 · 여행 취소보험 필수'
          ]
        },
      {
        ...
        cheapFlights: [
          { label:'제주항공 (직항)', desc:'1.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/fuk/' },
          { label:'진에어 (직항)', desc:'1.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/fuk/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'진에어 (직항)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cts/' },
          { label:'아시아나 (직항)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cts/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'제주항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/oka/' },
          { label:'진에어 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/oka/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'제주항공 (오사카 KIX 입국)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/kix/' },
          { label:'피치항공 (오사카 경유)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/ngoy/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'진에어 (인천→시모지시마 직항)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/shi/' },
          { label:'제주항공 (직항 운항시)', desc:'2.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/shi/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'비엣젯 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/pqc/' },
          { label:'베트남항공 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/pqc/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'제주항공 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/sgn/' },
          { label:'진에어 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/sgn/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'제주항공 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/han/' },
          { label:'베트남항공 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/han/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'세부퍼시픽 (칼리보)', desc:'4.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mph/' },
          { label:'제주항공 (직항)', desc:'4.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mph/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'에어아시아 (직항)', desc:'6시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/hkt/' },
          { label:'타이항공 (직항)', desc:'6시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/hkt/' }
        ],
      ...
      },
      {
        ...
        baseAir: 28, baseHotel: 15, baseHotelLow: 10, baseHotelHigh: 22, minDays: 3, minBudget: 55,
        sights: {
          low: [
        ...
        cheapFlights: [
          { label:'캐세이퍼시픽 (직항)', desc:'3.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/hkg/' },
          { label:'제주항공 (직항)', desc:'3.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/hkg/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'유나이티드항공 (직항)', desc:'4시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/gum/' },
          { label:'아시아나 (직항)', desc:'4시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/gum/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'하와이안항공 (직항)', desc:'9.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/hnl/' },
          { label:'대한항공 (직항)', desc:'9.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/hnl/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'에어프랑스 (직항)', desc:'12시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cdg/' },
          { label:'에미레이트 (경유)', desc:'약 15시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/cdg/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'에어아시아 (직항)', desc:'6.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/kul/' },
          { label:'말레이시아항공 (직항)', desc:'6.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/kul/' }
        ],
      ...
      },
      {
        ...
        baseAir: 55, baseHotel: 40, baseHotelLow: 22, baseHotelHigh: 110, minDays: 5, minBudget: 200,
        sights: {
          low: [
        ...
        cheapFlights: [
          { label:'스리랑카항공 (콜롬보 경유)', desc:'약 10시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mle/' },
          { label:'인디고 (델리 경유)', desc:'약 12시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mle/' }
        ],
      ...
      },
      {
        ...
        baseAir: 70, baseHotel: 22, baseHotelLow: 15, baseHotelHigh: 36, minDays: 7, minBudget: 160,
        sights: {
          low: [
        ...
        cheapFlights: [
          { label:'대한항공 (직항)', desc:'10시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/syd/' },
          { label:'젯스타 (경유)', desc:'약 13시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/syd/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'상하이항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/pvg/' },
          { label:'제주항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/pvg/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'에어유로파 (마드리드 경유)', desc:'약 14시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/bcn/' },
          { label:'에미레이트 (경유)', desc:'약 15시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/bcn/' }
        ],
      ...
      },
      {
        ...
        baseAir: 30, baseHotel: 14, baseHotelLow: 10, baseHotelHigh: 28, minDays: 3, minBudget: 60,
        ...
        cheapFlights: [
          { label:'에어부산 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/ngo/' },
          { label:'제주항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/ngo/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'비엣젯 (경유)', desc:'약 7시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/rep/' },
          { label:'진에어 (프놈펜 경유)', desc:'약 7시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/rep/' }
        ],
      ...
      },
      {
        ...
        baseAir: 80, baseHotel: 25, baseHotelLow: 17, baseHotelHigh: 48, minDays: 6, minBudget: 170,
        ...
        cheapFlights: [
          { label:'대한항공 (직항)', desc:'12시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/fco/' },
          { label:'에미레이트 (경유)', desc:'약 15시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/fco/' }
        ],
      ...
      },
      {
        ...
        baseAir: 85, baseHotel: 30, baseHotelLow: 22, baseHotelHigh: 48, minDays: 6, minBudget: 200,
        ...
        cheapFlights: [
          { label:'대한항공 (직항)', desc:'12시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/lhr/' },
          { label:'핀에어 (경유)', desc:'약 14시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/lhr/' }
        ],
      ...
      },
      {
        ...
        baseAir: 35, baseHotel: 8, baseHotelLow: 5, baseHotelHigh: 17, minDays: 4, minBudget: 60,
        ...
        cheapFlights: [
          { label:'에어아시아 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/bki/' },
          { label:'진에어 (직항)', desc:'5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/bki/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'비엣젯 (하노이 경유)', desc:'약 6시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/lpq/' },
          { label:'방콕항공 (방콕 경유)', desc:'약 8시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/lpq/' }
        ],
      ...
      },
      {
        ...
        baseAir: 80, baseHotel: 22, baseHotelLow: 15, baseHotelHigh: 35, minDays: 6, minBudget: 160,
        ...
        cheapFlights: [
          { label:'이베리아 (직항/경유)', desc:'14시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mad/' },
          { label:'카타르 (경유)', desc:'약 14시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mad/' }
        ],
      ...
      },
      {
        ...
        cheapFlights: [
          { label:'방콕항공 (방콕 경유)', desc:'약 7시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/usm/' },
          { label:'타이항공+방콕항공', desc:'약 8시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/usm/' }
        ],
      ...
      },
      {
        ...
        baseAir: 90, baseHotel: 22, baseHotelLow: 14, baseHotelHigh: 35, minDays: 5, minBudget: 200,
        ...
        cheapFlights: [
          { label:'대한항공 (취리히 직항)', desc:'12시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/zrh/' },
          { label:'루프트한자 (경유)', desc:'약 14시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/zrh/' }
        ],
      ...
      },
      {
        ...
        baseAir: 85, baseHotel: 28, baseHotelLow: 18, baseHotelHigh: 55, minDays: 5, minBudget: 170,
        ...
        cheapFlights: [
          { label:'터키항공 (이스탄불 경유)', desc:'약 14시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/dbv/' },
          { label:'루프트한자 (프랑크푸르트 경유)', desc:'약 14시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/dbv/' }
        ],
        flightTips: ['직항 없음 14-18시간','왕복 70-120만원','자그레브/스플리트에서 국내선 연결','쉥겐 비자 무필요 (90일 무비자)']
      },
      {
        ...
        baseAir: 70, baseHotel: 9, baseHotelLow: 5, baseHotelHigh: 18, minDays: 5, minBudget: 100,
        sights: {
          low: [
        ...
        cheapFlights: [
          { label:'터키항공 (직항)', desc:'11시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/ist/' },
          { label:'대한항공 (직항)', desc:'11시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/ist/' }
        ],
      ...
      // ── 마카오 (2nd) ──
      {
        ...
        baseAir: 25, baseHotel: 12, baseHotelLow: 7, baseHotelHigh: 35, minDays: 3, minBudget: 50,
        sights: {
          low: [
        ...
        cheapFlights: [
          { label:'에어마카오 (직항)', desc:'3.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mfm/' },
          { label:'홍콩 경유', desc:'4시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/mfm/' }
        ],
      ...
      // ── 베이징 ──
      {
        ...
        cheapFlights: [
          { label:'대한항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/pek/' },
          { label:'티웨이항공 (직항)', desc:'2시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/pek/' }
        ],
      ...
      // ── 칭다오 ──
      {
        ...
        cheapFlights: [
          { label:'직항', desc:'1시간 30분', link:'https://www.skyscanner.co.kr/transport/flights/icn/tao/' },
          { label:'대한항공·아시아나', desc:'1.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/tao/' }
        ],
      ...
      // ── 사이판 ──
      {
        ...
        baseAir: 35, baseHotel: 16, baseHotelLow: 10, baseHotelHigh: 32, minDays: 3, minBudget: 60,
        sights: {
          low: [
        ...
        cheapFlights: [
          { label:'제주항공 (직항)', desc:'4시간 30분', link:'https://www.skyscanner.co.kr/transport/flights/icn/spn/' },
          { label:'티웨이항공 (직항)', desc:'4.5시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/spn/' }
        ],
      ...
      // ── 팔라완 ──
      {
        ...
        cheapFlights: [
          { label:'세부퍼시픽 (마닐라 경유)', desc:'약 7시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/pps/' },
          { label:'에어스위프트 (엘니도 직항)', desc:'약 6시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/eni/' }
        ],
      ...
      // ── 삼아 (하이난) ──
      {
        ...
        baseAir: 20, baseHotel: 10, baseHotelLow: 6, baseHotelHigh: 21, minDays: 3, minBudget: 45,
        sights: {
          low: [
        ...
        cheapFlights: [
          { label:'중국남방항공 (직항)', desc:'4시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/syx/' },
          { label:'제주항공 (직항)', desc:'4시간', link:'https://www.skyscanner.co.kr/transport/flights/icn/syx/' }
        ],
